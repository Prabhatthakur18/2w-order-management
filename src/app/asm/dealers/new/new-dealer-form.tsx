...
import { verifyGstin, createDealer } from "../actions";
...
/**
 * GSTIN drives auto-fill via a Verify button, but every field stays
 * editable afterwards — the lookup is a convenience, not a lock. Submitting
 * always creates a PENDING dealer; Admin approves separately.
 */
